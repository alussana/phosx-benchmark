...
def main():
    ...
    kinase_activity_kinex_df.to_csv(f'{out_prefix}hernandez2017_kinase_activity_kinex.tsv', header=True, index=True, sep='\t')
    ##########
    ...
    plt.legend('upper left', frameon=False, labels=["Upregulated", "Downregulated"])
    sns.despine()
    plt.tight_layout()
    ...
    sns.despine()
    plt.tight_layout()
    plt.savefig(f'{out_prefix}hernandez2017_Kinex_score_regulated_kinases_intersection.pdf')
